...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
			List<PhantomReference<Monkey>> listPhMonk= new ArrayList<PhantomReference<Monkey>>();
			for (int i = 0; i < 200 ; i++) {
				Monkey monkey = new Monkey();
				PhantomReference<Monkey> referencePh = new PhantomReference<Monkey>(monkey,helper.getQueue());
				listPhMonk.add(referencePh);
			}
            return listPhMonk;
        }
