...
//        logger.debug("Constructor:\tvalue1 = " + value1 + "\tvalue2 = " + value2 + "\tvalue3 = " + value3);
        ...
        this.value2 = value2;
        this.value3 = value3;
//		logger.debug(String.valueOf(this.value1) + ", " + String.valueOf(this.value2) + ", " + String.valueOf(this.value3));
    }
...
//        logger.debug("setValue1: value1 = " + value1);
        this.value1 = value1;
//		logger.debug(String.valueOf(this.value1));
    }

    public void setValue2(String value2) {
//        logger.debug("setValue1: value2 = " + value2);
        this.value2 = value2;
//		logger.debug(String.valueOf(this.value2));
    }

    public void setValue3(Date value3) {
//        logger.debug("setValue1: value3 = " + value3);
        this.value3 = value3;
//		logger.debug(String.valueOf(this.value3));
    }
}
