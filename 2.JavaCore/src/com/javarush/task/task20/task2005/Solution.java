...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.print(ivanov.name + " " + ivanov.assets.get(0).getName() + " " + ivanov.assets.get(1).getName());
            System.out.println();
            System.out.print(somePerson.name + " " + somePerson.assets.get(0).getName() + " " + somePerson.assets.get(1).getName());
			System.out.println();
